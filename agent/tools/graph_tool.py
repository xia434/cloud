...
def _get_graph_chain():
    ...
    # Schema discovery is complete. Guard every subsequent LLM-generated query.
    original_query = graph.query

    def _read_only_query(query: str, params: dict | None = None, **kwargs):
        validate_read_only_cypher(query)
        return original_query(query, params=params or {}, **kwargs)

    object.__setattr__(graph, "query", _read_only_query)
...
{question}"""
    ...
    _graph_chain_instance = GraphCypherQAChain.from_llm(
        ...
        # GraphCypherQAChain requires this acknowledgement. Actual writes are
        # blocked by ReadOnlyNeo4jGraph.query above.
